...
- `src/world/chunkSnapshot.ts`: versioned resident-chunk and edited-chunk snapshot schemas plus JSON-safe row-major dense RLE payload and sparse tile-index/value payload encoders/decoders for future save/load work.
