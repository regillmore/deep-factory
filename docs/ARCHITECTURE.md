...
- `src/input/`: input abstraction for keyboard, mouse, touch/pinch, standalone player intent extraction, and shortcut resolution helpers including paused-main-menu shortcut availability context.
