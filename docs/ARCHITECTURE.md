...
- `src/input/`: input abstraction for keyboard, mouse, touch/pinch, standalone player intent extraction, and shortcut resolution helpers including paused-main-menu and in-world shell shortcut availability helpers plus a shared runtime shortcut-context composer.
