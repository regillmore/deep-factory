...
- `src/main.ts`: bootstrapping, app-shell coordination, dependency wiring, paused-session save export plus restore runtime actions, renderer entity-pass submission assembly from entity-registry snapshots, render-frame camera-follow alignment to interpolated standalone-player snapshots, and render-frame debug telemetry selection.
