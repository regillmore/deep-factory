...
152. Surface standalone player live camera world position in the text debug HUD alongside the existing follow telemetry.

## Project structure optimization

151. Extend deployment regression coverage to assert emitted HTML and CSS assets omit exact double-prefixed `'/deep-factory/deep-factory/atlas/'` static-asset URL prefix literals in production output.
