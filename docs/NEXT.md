...
137. Surface standalone player live camera-follow focus-point world tile coordinates in the compact debug-edit status strip alongside the existing focus-point position line.
