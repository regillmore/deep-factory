...
461. Add paused-menu `Results` summary copy that surfaces when the collapsed section contains shell-setting feedback only, with paused-results-shell-settings-only regressions.
