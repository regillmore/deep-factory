...
553. Replace grass growth/regrowth behavior to instead periodically spread grass to sunlit adjacent dirt tiles within height 1. Acorn growth might be a good model to extend or replicate.
