...
558. Add seeded surface-flower worldgen after the surface-flower decoration slice: occasional placeholder flowers on exposed procedural grass during chunk generation, plus deterministic terrain regressions.
