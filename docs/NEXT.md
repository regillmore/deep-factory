...
564. Add streamed procedural small-tree sapling growth tracking after seeded small-tree sapling worldgen: register procedurally loaded planted anchors when resident chunks stream in, and add deterministic runtime regressions.
