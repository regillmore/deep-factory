...
552. Exposed dirt tiles adjacent to surface grass should store liquid-clear regrowth overrides across pruned chunk boundaries without forcing the dirt chunk resident.
