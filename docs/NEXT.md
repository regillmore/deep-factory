...
458. Add paused-menu `Results` summary copy that surfaces when the collapsed section combines world-save and shell-setting feedback categories, with paused-results-category-summary regressions.
