...
568. Add a current-versus-max mana telemetry follow-up after the mana-crystal upgrade slice: full debug HUD and compact status-strip mana readouts plus render-frame telemetry regressions.
