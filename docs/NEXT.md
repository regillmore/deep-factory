...
434. Add paused-menu `Shell Profile Preview` change-summary rows that surface which live shell toggles or hotkeys would change on apply, with shell-profile-preview-diff regressions.
