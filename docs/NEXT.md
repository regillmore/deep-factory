...
133. Surface standalone player live camera world chunk coordinates in the compact debug-edit status strip now that camera world tile coordinates are available.
