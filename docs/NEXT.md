...
554. Add a tall-grass decoration slice after periodic grass spread: placeholder non-solid tall-grass tiles on sunlit surface grass, direct-cover cleanup, and deterministic growth regressions.
