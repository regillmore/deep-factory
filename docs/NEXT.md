...
563. Refresh the single-leaf small-tree-leaf atlas sprite: committed placeholder multi-leaf foliage block art aligned with the new tall-grass and surface-flower palette, plus authored-atlas regressions.
