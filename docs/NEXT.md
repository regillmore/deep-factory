...
455. Add paused-menu `Results` summary copy that surfaces when the collapsed section contains warning-toned feedback only, with paused-results-warning-summary regressions.
