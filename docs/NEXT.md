...
556. Add a distinct atlas sprite for tall-grass after the tall-grass decoration slice: committed placeholder tall-grass art plus authored-atlas regressions. The look should align with the grass tile sprite, which can also be updated.
...
559. Add seeded tall-grass worldgen after seeded surface-flower worldgen: deterministic placeholder tall grass on exposed procedural grass anchors not already claimed by blooms during chunk generation, plus terrain regressions.
