...
317. Add paused-menu persistence-summary copy that explains when validated in-world shell-action keybindings have fallen back to the default set after load, with shell-action storage regressions.
