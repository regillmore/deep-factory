...
305. Add a renderer regression where reclosing a streamed-back row-below bottom-corner boundary blocker still invalidates both row-below chunk meshes before the first rebuilt draw.
