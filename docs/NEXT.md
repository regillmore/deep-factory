...
379. Expose active-liquid chunk bounds in renderer telemetry and the debug HUD so liquid sleep or wake follow-ups can verify which resident region stays active after a disturbance.
