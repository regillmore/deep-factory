...
459. Add paused-menu `Results` summary copy that surfaces when the collapsed section contains world-save feedback only across multiple result cards, with paused-results-world-save-category regressions.
