...
460. Add paused-menu `Results` summary copy that surfaces when the collapsed section contains three or more result cards at once, with paused-results-three-card-density regressions.
