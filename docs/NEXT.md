...
555. Add a surface-flower decoration slice after tall-grass decoration: placeholder non-solid flower tiles on sunlit surface grass, support-loss cleanup, and deterministic growth regressions.
556. Add a distinct atlas sprite for gently animated tall-grass. Tree foliage animation may be a good reference point.
