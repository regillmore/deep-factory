...
- On-canvas one-shot preview badges append affected-tile estimates for live drag previews and show pending counts for anchored touch previews before the second point is chosen.
