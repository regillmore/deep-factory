...
- Renderer draws the standalone player through a facing-aware world-space placeholder pass with grounded idle, alternating grounded-walk, jump-rise, fall, airborne wall-slide, and airborne ceiling-bonk silhouettes instead of a client-space DOM marker, and keeps the ceiling-bonk pose briefly latched after contact clears so fixed-step head hits still read visually.
