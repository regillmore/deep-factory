...
- On-canvas one-shot preview badges append inclusive span dimensions plus affected-tile estimates for live drag previews and show pending span and count text for anchored touch previews before the second point is chosen.
