...
- Hovered and touched inspect readouts include tile name, tile ID, world plus chunk and chunk-local coordinates, solid, light-blocking, and liquid flags, plus the resolved liquid cardinal mask and liquid variant source for liquid tiles.
