...
- Renderer draws the standalone player through a facing-aware world-space placeholder pass with grounded idle, alternating grounded-walk, jump-rise, fall, and airborne wall-slide silhouettes instead of a client-space DOM marker.
