...
- Hovered and touched inspect readouts include tile name, tile ID, world plus chunk and chunk-local coordinates, solid, light-blocking, and liquid flags, plus the resolved liquid connectivity-group label, liquid cardinal mask, liquid variant source, liquid variant UV rect, and liquid variant atlas pixel bounds for liquid tiles.
