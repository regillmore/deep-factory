...
- Deployment regression coverage temp-builds the production app, verifies the `/deep-factory/` bundle URLs, scans emitted `index.html` to reject both root-relative `"/assets/..."` and double-prefixed `"/deep-factory/deep-factory/assets/..."` script and stylesheet URLs plus the exact root-relative single-quoted `'/atlas/tile-atlas.png'`, exact root-relative double-quoted `"/atlas/tile-atlas.png"`, and exact double-prefixed `"/deep-factory/deep-factory/atlas/tile-atlas.png"` authored-atlas runtime URL literals, scans every emitted CSS asset to reject the exact root-relative `"/assets/"` bundle literal, the exact double-prefixed `"/deep-factory/deep-factory/assets/"` bundle literal, and those same root-relative and double-prefixed authored-atlas runtime URL literals, scans every emitted JavaScript asset to reject the exact root-relative `"/assets/"` bundle literal, the exact double-prefixed `"/deep-factory/deep-factory/assets/"` bundle literal, any exact quoted root-relative `/atlas/tile-atlas.png` literal, and the exact double-prefixed `"/deep-factory/deep-factory/atlas/tile-atlas.png"` authored-atlas runtime URL literal while the exact joined runtime atlas fetch URL `/deep-factory/atlas/tile-atlas.png` still appears exactly once across the full emitted JS set, and byte-compares the copied authored atlas output at `dist/atlas/tile-atlas.png` against `public/atlas/tile-atlas.png`.
