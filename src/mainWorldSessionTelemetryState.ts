...
export const WORLD_SESSION_TELEMETRY_TYPE_DEFINITIONS = [
  ...
  },
  {
    ...
    label: 'Combat',
    description:
      'Current/max health, current-session death count, death-hold, respawn countdown, breath, water or lava overlap, drowning or lava cooldowns, survival damage-event readouts including hard-landing impact speed, and the latest lethal damage source plus player world tile.'
  },
  {
    id: 'player-camera',
    collectionId: 'player',
